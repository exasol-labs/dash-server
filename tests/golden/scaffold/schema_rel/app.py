...
BUSINESS_SUMMARY_HEADING = 'Line KPI Snapshot'
BUSINESS_CHART_HEADING = 'Line Trend'
BUSINESS_TABLE_HEADING = 'Line Detail'
...
def create_dash_app(server, url_base_pathname, metadata):
    app = Dash(
        ...
        title=metadata.get("title", 'Golden schema_rel'),
    )
    app.layout = html.Div(
        [
            dcc.Interval(id="refresh", interval=15000, n_intervals=0),
            html.H1(metadata.get("title", 'Golden schema_rel')),
