...
BUSINESS_SUMMARY_HEADING = 'Orders KPI Snapshot'
BUSINESS_CHART_HEADING = 'Orders Trend'
BUSINESS_TABLE_HEADING = 'Orders Detail'
...
def create_dash_app(server, url_base_pathname, metadata):
    app = Dash(
        ...
        title=metadata.get("title", 'Golden schema_full'),
    )
    app.layout = html.Div(
        [
            dcc.Interval(id="refresh", interval=15000, n_intervals=0),
            html.H1(metadata.get("title", 'Golden schema_full')),
